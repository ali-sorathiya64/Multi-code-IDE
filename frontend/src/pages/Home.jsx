        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-10">
          {projects && projects.length > 0 ? (
            projects.map((project) => (
              <div
                key={project._id}
                className="project p-5 bg-white rounded-2xl shadow-2xl hover:shadow-3xl transition-all"
              >
                <div
                  onClick={() => {
                ...
                <div className="mt-4 flex justify-between">
                  <button
                    className="btn bg-cyan-500 text-white hover:bg-cyan-600 transition-all rounded-full py-2 px-4 shadow-lg"
                    onClick={() => {
                  ...
                  <button
                    ...
                    className="btn bg-red-500 text-white hover:bg-red-600 transition-all rounded-full py-2 px-4 shadow-lg"
                  >
                    Delete
                  </button>
                </div>
            ...
            <div className="modelBox p-8 bg-white rounded-2xl shadow-2xl text-black w-[90vw] sm:w-[80vw] md:w-[60vw] lg:w-[40vw] xl:w-[30vw]">
              ...
              <div className="inputBox w-full mb-4">
                <input
                  ...
                  className="w-full p-3 text-black rounded-md border-2 border-cyan-500"
                />
              </div>
              <Select
              ...
              {selectedLanguage && (
                <>
                  ...
                  <button
                    onClick={createProj}
                    className="btn bg-gradient-to-r from-cyan-500 to-teal-400 text-white hover:from-cyan-600 hover:to-teal-500 transition-all rounded-lg py-2 px-4 mt-2 shadow-lg"
                  >
                    Create
                  </button>
                </>
